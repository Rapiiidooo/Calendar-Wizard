...
class MainApplication(tk.Frame):
    ...
    def actionImportModel(self):
        ...
        filename = askopenfilename(title="Ouvrir votre document",
                                   filetypes=[('scrubus files', '.sla'), ('all files', '.*')])
    ...
    def actionSelectMonth(self, event):
        ...
        for tous in self.Frame2_config_monthIndexSelected:
            ...
            self.Frame2_config_monthStringSelected.append(
                localization[self.Frame2_listbox.get(self.Frame2_config_languageIndexSelected)][0][tous])
    ...
    def makeBottom(self):
        ...
        self.bottom_button = [Button(self.bottom, text="prev", command=self.actionDecrement),
                              Button(self.bottom, text="next", command=self.actionIncrement),
                              Button(self.bottom, text="finish")]
        for i in range(0, 3):
            self.bottom_button[i].grid(row=0, column=i)

    def makeFrames(self):
        ########### ELEMENT MIDDLE FRAME 1
        Frame1_root = Frame(self.canvas_frame, padx=20, pady=20)
        ...
        Frame1_frame_types = Frame(Frame1_root, width=20)
        ...
        self.previewCanvas = Canvas(Frame1_frame_preview, width=200, height=220)
        self.myimg = self.previewCanvas.create_image(0, 0, anchor=NW, image=self.photo)
        self.previewCanvas.pack()

        ########### ELEMENT MIDDLE FRAME 2
        Frame2_root = Frame(self.canvas_frame, padx=20, pady=20)
        ...
        Frame2_frame_import.grid(row=3, column=2, rowspan=4, columnspan=1, sticky=W + E + N + S, padx=50, pady=50)
        ...
        Frame2_checkbox1 = Checkbutton(Frame2_option, text="Numero de jour",
                                       variable=self.Frame2_config_checkoption1)  # command=self.cb)
        Frame2_checkbox2 = Checkbutton(Frame2_option, text="Nom de jour entier",
                                       variable=self.Frame2_config_checkoption2)  # command=self.cb)
        Frame2_checkbox3 = Checkbutton(Frame2_option, text="Afficher mois suivant",
                                       variable=self.Frame2_config_checkoption3)  # command=self.cb)
        Frame2_checkbox4 = Checkbutton(Frame2_option, text="Afficher mois precedent",
        ...
        ########### ELEMENT MIDDLE FRAME 2
        Frame3_root = Frame(self.canvas_frame, padx=20, pady=20)
